...
def get_pred_gt_name(translator: Translator, idx2word, b_image, b_gt, b_name, num, dict_path, rotate,rgb2gray,is_test_gt=True):
    # rgb2gray=False
...
def eval(cfg, args,model_path):
    ...
    with open("ocr_config.pickle", "wb") as file_handle:
        pickle.dump(cfg, file_handle)
