...
if __name__ == '__main__':
    ...
    parser.add_argument('--arch', default='tbsrn', choices=['tbsrn', 'car', 'tsrn', 'bicubic', 'bilinear', 'area', 'nearest', 'srcnn', 'vdsr', 'srres', 'esrgan', 'rdn',
                                                           'edsr', 'lapsrn'])
    ...
    parser.add_argument('--cdistresume', type=str, default='/home/philipp/FudanOCR/scene-text-telescope/checkpoint/carcdistfinetunedsave/epoch7_.pth', help='')
